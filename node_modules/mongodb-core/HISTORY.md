...
1.1.19 2015-03-21
-----------------
- Made kerberos module ~0.0 to allow for quicker releases due to base.js of kerberos module.
...
1.1.9 2015-21-01
----------------
- Updated BSON dependency to 0.2.18 to fix issues with base.js and node.
- Updated Kerberos dependency to 0.0.8 to fix issues with base.js and node.
